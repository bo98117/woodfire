 ...
 * @author paul
 */
public class PorkButtController implements Initializable {
    
    @FXML
    public void ingredients(ActionEvent event) throws IOException {
        Parent dinoRibsParent = FXMLLoader.load(getClass().getResource("PorkButtIngredients.fxml"));
    ...
    public void technique(ActionEvent event) throws IOException {
        Parent dinoRibsParent = FXMLLoader.load(getClass().getResource("PorkButtTechnique.fxml"));
        Scene dinoRibsScene = new Scene(dinoRibsParent);
