 ...
 * @author paul
 */
public class DinoRibsController implements Initializable {
    
    @FXML
    public void ingredients(ActionEvent event) throws IOException {
        Parent dinoRibsParent = FXMLLoader.load(getClass().getResource("DinoIngredients.fxml"));
    ...
    public void technique(ActionEvent event) throws IOException {
        Parent dinoRibsParent = FXMLLoader.load(getClass().getResource("DinoTechnique.fxml"));
        Scene dinoRibsScene = new Scene(dinoRibsParent);
